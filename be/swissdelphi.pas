{ This unit is used by Enigma but not created by Enigma.
  The copy right clausule from the Swiss Ephemeris does apply.
  Please check the file copyright.txt in the root of the source for further details. }
unit swissdelphi;
{< Methods and constants to access the Swiss Ephemeris dll, existing unit as supplied by Pierre Fontaine et al.@br
The unit is downloaded from the site of the Swiss Ephemeris.}
