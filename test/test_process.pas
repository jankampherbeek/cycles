...
type
  ...
  //TestSeriesHandler = class(TTestCase)
  //protected
  //published
  //  procedure TestHappyFlow;
  //end;
...
//{ TestSeriesHandler ----------------------------------------------------------------------------------------------- }
//procedure TestSeriesHandler.TestHappyFlow;
//var
...
//  AllCelPoints[0] := CelPointSun;
//  AllCelPoints[1]:= CelPointMoon;
...
//  Response := Handler.HandleSingleRequest(Request);
